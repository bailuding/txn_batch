...
Overall, using batching at storage and/or validator consistently leads to significant improvements in performance, up to 2.7x in throughput. In addition, storage and validator reordering consistently further improve the throughput to up to 1.3x as compared to $batch$. Moreover, validator reordering significantly reduces the average latency, by up to 67\%, and the percentile latencies, by up to 82\%, as compared to $baseline$.
