...
Transaction scheduling has also been studied in the real-time databases, where urgent or high value transactions are prioritized~\cite{haritsa1993value}.
...
Transactions can be batched and serialized before execution~\cite{thomson2012calvin, mu2014extracting, faleiro2014rethinking}. These are complementary to our work. Our approach is more flexible as it allows reordering at multiple stages in a transaction's life cycle.
