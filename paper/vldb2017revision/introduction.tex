...
The architecture of our system is best suited to integrate into a versioned key-value store. The key-value stores provide the flexibility of implementing a customized validation protocol, especially with our design of parallelized validator. Our previous work on Centiman~\cite{ding2015centiman} has a detailed discussion on the architecture of a loosely coupled OCC system with a versioned key-value store.
