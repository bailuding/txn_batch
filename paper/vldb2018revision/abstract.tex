...
In-depth experiments on a research prototype, an open-source OLTP system, and a production OLTP system show that our techniques can increase system throughput by up to 5.0x and reduce tail latency by up to 91\% on workloads with high data contention.
} 
\end{abstract}