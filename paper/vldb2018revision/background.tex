...
For now, we assume the validation phase is sequential for ease of understanding.
\changed{In Appendix~\ref{sec:validator_reordering:parallel}, we will also discuss how to parallelize all aspects of validation. 
