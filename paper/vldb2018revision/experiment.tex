...
\changed{We first describe the experimental setup for our research prototype where we tease apart the impact of different parameters in our algorithms. Section \ref{sec:OtherOLTP} describes our experiments with an open-source OLTP system, and Section \ref{subsec:experiment:compare} describes our experiments with a commercial database system; both of these sections have their own experimental setup.}
