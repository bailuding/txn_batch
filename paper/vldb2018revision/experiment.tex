...
\begin{figure*}[t]
	...
	\begin{minipage}[b]{0.31\linewidth}
		\centering
		\includegraphics[width=\textwidth]{./exp_fig/oltp_kernel/pdf/tps}
		%		\vspace{-2em}
		\caption{Throughput of YCSB}
		\label{fig:oltp_kernel:tps}
	\end{minipage}
	\begin{minipage}[b]{0.31\linewidth}
		\centering
		\includegraphics[width=\textwidth]{./exp_fig/oltp_kernel/pdf/abort}
		%	\vspace{-2em}
		\caption{Abort rate of YCSB}
		\label{fig:oltp_kernel:latency}
	\end{minipage}
	\begin{minipage}[b]{0.31\linewidth}
		\centering
		\includegraphics[width=\textwidth]{./exp_fig/oltp_kernel/pdf/latency}
		%	\vspace{-2em}
		\caption{Percentile latency of YCSB}
