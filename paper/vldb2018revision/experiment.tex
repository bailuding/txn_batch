...
\vspace{-0.5em}
\item How do we incorporate our techniques on top of a state-of-the-art OLTP system and a commercial database, and what is the resulting performance? (Section~\ref{sec:OtherOLTP} and~\ref{subsec:experiment:compare})
\end{enumerate}
Table~\ref{tbl:exp} summarizes the trade-offs of parameters evaluated. We further evaluate the parallelization of our algorithms in details in Appendix \ref{sec:experiments:parallel}.
