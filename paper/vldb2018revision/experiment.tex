...
\vspace{-0.5em}
\item How do we incorporate our techniques on top of a commercial DBMS and what is the resulting performance?
\vspace{-0.5em}
\item  and how do our techniques improve its performance under data contention?
\end{enumerate}
...
\changed{(5) Integrating our techniques to a high performance OLTP kernel (Cicada) shows that, compared with the-state-of-the-art OLTP kernels, the thread-aware reordering policy improves transaction throughput by a factor of up to 5.0x and reduces the 99\% latency by a factor of up to 11x under a write-intensive workload.}
