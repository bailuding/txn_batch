...
'./data/reorder_b1_t28_z0.4_latency.dat' using ($2/1000), \
'./data/cicada_t28_z0.4_latency.dat' using ($2/1000):key(1), \
...
'./data/reorder_b1_t28_z0.6_latency.dat' using ($2/1000), \
'./data/cicada_t28_z0.6_latency.dat' using ($2/1000), \
...
'./data/reorder_b1_t28_z0.8_latency.dat' using ($2/1000), \
'./data/cicada_t28_z0.8_latency.dat' using ($2/1000), \
...
'./data/reorder_b1_t28_z0.9_latency.dat' using ($2/1000), \
'./data/cicada_t28_z0.9_latency.dat' using ($2/1000), \
...
'./data/reorder_b1_t28_z0.95_latency.dat' using ($2/1000), \
'./data/cicada_t28_z0.95_latency.dat' using ($2/1000), \
...
'./data/reorder_b1_t28_z0.99_latency.dat' using ($2/1000), \
'./data/cicada_t28_z0.99_latency.dat' using ($2/1000), \
