...
tail latency. 
\cut{While our first latency-aware policy $rct$ performs similar to $mc$,} The more advanced policy $rdeg$ consistently performs significantly better than all the others, and it reduces the tail latency by up to 86\%.
\cut{
