...
tail latencies. 
\cut{While our first latency-aware policy $rct$ performs similar to $mc$,} The more advanced policy $rdeg$ consistently performs significantly better than all the others, and it reduces the tail latencies by up to 86\%.
\cut{
