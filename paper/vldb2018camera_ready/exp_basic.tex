...
We further evaluate the impact of batching and reordering on the Small Bank Benchmark~\cite{alomari2008icde}. The Small Bank benchmark contains transactions with a realistic and diverse
