...
Here, we discuss other related work\cut{ on concurrency control under high data contention, transaction scheduling, and batching. }\eat{, and data clustering techniques.}
