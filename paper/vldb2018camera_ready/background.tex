...
\changed{For the ease of explanation, we assume the validation phase is sequential, however all aspects of validation can be easily parallelized as discussed in Section~\ref{sec:validator_reordering:parallel}. 
}
