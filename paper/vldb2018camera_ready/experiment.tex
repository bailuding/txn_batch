...
Our \changed{research prototype system architecture} has four components: Transaction clients, processors, storage, and a validator. The components communicate through consumer-producer queues. 
