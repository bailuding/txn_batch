...
% time complexity analysis.
As with the previous algorithm, trimming and updating the graph after removing a node take $O(|V|+|E|)$ in total. Updating the weights of the remaining nodes takes $O(|V|)$ per iteration. The
