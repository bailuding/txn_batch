...
set ylabel 'Throughput (K) / Second'
# set styles
...
set key font "Times,40" at graph .98,graph .98 spacing 1 width -1 samplen 1.5

set output 'tmp.eps'


set style data linespoints
set key maxrows 1 at graph 0.98,graph 0.98 Left
set xlabel offset 0,-5.5

set key maxrows 3 at graph 0.98,graph 0.32 width -2 Left
...
plot \
'data/hekaton_nobatch_tps.dat' \
using 1:2 title 'nobatch' ls 1, \
'data/hekaton_normal_tps.dat' \
using 1:2 title 'batch' ls 2, \
'data/hekaton_reorder_tps.dat' \
