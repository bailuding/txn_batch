...
\begin{figure*}[t]
	...
	\begin{minipage}[b]{0.32\linewidth}
		\centering
		\includegraphics[width=\textwidth]{{{./exp_fig/compare/z0.5_rst_latency100}}}
		\vspace{-2em}
		\caption{Percentile latency with micro benchmark (skew factor 0.5)}
		\label{fig:compare:z0.5_p100}
	\end{minipage}
	\begin{minipage}[b]{0.32\linewidth}
	\centering
	\includegraphics[width=\textwidth]{{{./exp_fig/compare/z0.7_rst_latency100}}}
	\vspace{-2em}
	\caption{Percentile latency with micro benchmark (skew factor 0.7)}
	\label{fig:compare:z0.7_p100}
	\end{minipage}
	\begin{minipage}[b]{0.32\linewidth}
	\centering
	\includegraphics[width=\textwidth]{{{./exp_fig/compare/z0.9_rst_latency100}}}
	\vspace{-2em}
	\caption{Percentile latency with micro benchmark (skew factor 0.9)}
	\label{fig:compare:z0.9_p100}
	\end{minipage}
%	\begin{minipage}[b]{0.32\linewidth}
%	\centering
...
\item Finally, our techniques help the system performance degrade elegantly under data contention comparing to other systems.
%\vspace{-.5em}
\end{enumerate}  
