...
\section{Parallel Reordering and Validation}
\label{sec:parallel}
\label{subsec:validator_reordering:parallel}
Since reordering occurs online in transaction execution, it can increase the overall latency 
%of a transaction, 
resulting in a higher chance of conflicts. We explain how parallelization can alleviate this problem by reducing the amortized overhead of reordering.
