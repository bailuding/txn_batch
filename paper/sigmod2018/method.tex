...
% Figure
 ...
 Make the point that we validate twice and that this is a valluable optimization because the cost of the reordering is so high.
...
%For pipelined parallelism, we can run each of the three validator subcomponents in a different thread. 
% We can pipeline batches through these components, 
