...
The policy $P$ is at the heart of the algorithm, and it ranks vertices which are likely to be in a desirable FVS highly. We discuss possible policies in Section \ref{subsec:validator_reordering:policy}.
