...
Batching transactions accessing the same objects together reduces inter-batch aborts. There has been a lot of research on data clustering either online or offline~\cite{elmore2015squall, pavlo2012skew}, especially for fine-grained data partitioning. 
