...
\item Our first contribution is an enhanced OCC system architecture that utilizes batching and reordering at the storage and the validator levels. We analyze the reasons for conflicts and aborts at each stage of a transaction's life cycle, and develop techniques to reduce these aborts through semantic batching.
% integration of our architecture into a realistic system.
% contribution 2: validator reordering algorithms
\item Our second contribution is an optimal algorithm for storage reordering and
