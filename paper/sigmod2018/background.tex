...
For now, we assume the validation phase is sequential for ease of understanding. We will extend it to a parallelized design in Section~\ref{subsec:validator_reordering:parallel}. 
